...
steps = [('mlp', MLPClassifier(hidden_layer_sizes=(100, 25), random_state=1, max_iter=1200, verbose=True, learning_rate_init=0.001, solver='adam', alpha=0.001, batch_size=32))]
